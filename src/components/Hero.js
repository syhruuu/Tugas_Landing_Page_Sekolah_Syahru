    ...
    >
      ...
      >
        <div className="hero-content text-white text-center">
          <h1 style={{ fontSize: "86px", fontWeight: 600, fontFamily:"Phenomena" }}>SMK TI BAZMA</h1>
          <p style={{ fontSize: "32px" }}>
            Merajut Asa, Menjejak &amp; Menebar Manfaat
          </p>
          <Button style={{ fontSize: "18px", padding: "10px 20px", fontFamily: "Phenomena", }} variant="secondary" href="#profil">
            Info
          </Button>
        </div>
      </div>
